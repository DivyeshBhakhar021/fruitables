...
import { addsubcategory, deleteSubcategory, getsubcategory, updateSubCategory } from '../../../reduct/slice/subcategory.slice';
                ...
                <form onSubmit={handleSubmit}>
                    <DialogContent>
                        <FormControl fullWidth margin="dense">
                            <InputLabel id="categoriesid-label">Select Category</InputLabel>
                            <Select
                                labelId="categoriesid-label"
                                id="categoriesid"
                                name="categoriesid"
